        ...
        class CleanScene extends Phaser.Scene {
            ...
            create() {
                ...
                */
                ...
                this.showMes("Drag the vegetables to the sink to clean them. Drag the spray bottle to the cutting board to disinfect it. Drag the glove box to the volunteer to clean hands and put on new gloves. Drag the food to the cutting board to chop it.")
            ...
            showMes(message) {
                ...
                const box = this.add.container(width * 0.4, height * 0.5);
